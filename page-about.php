...
<section class="banner">
    <div class="banner__word _content _py">
        ...
        <a class="banner__btn _btn" href="index.html#curs">Начать обучение</a>
...
<section class="documents _content _py">
    ...
    <div class="documents__bottom">
        <div class="documents__words">
            ...
            <a class="_text-lvl_1" href="assets/documents/oferta.docx" download><img src="assets/media/icons/document-text.svg" alt="document-text">Скачать публичную оферту</a>
            <a class="_text-lvl_1" href="assets/documents/oferta.docx" download><img src="assets/media/icons/document-text.svg" alt="document-text">Скачать политику конфиденциальности</a>
        </div>
        <div class="documents__imgs">
            <img class="documents__img" src="assets/media/page-about/about-сertificate-1.jpg" alt="about-сertificate">
            <img class="documents__img" src="assets/media/page-about/about-сertificate-2.jpg" alt="about-сertificate">
        </div>
    </div>
</section>